...
namespace CastleGrimtol.Project
{
    public class Game : IGame
    {
        ...
        public void Setup()
        {
            ...
            Room EntryHallway = new Room("Entry Hallway", "You find yourself in a small hall and there doesn't appear to be anything of interest here. You see a door to your ['N'], and to the  ['S'].  Straight ahead to the ['E'] is an open archway.  This appears to lead to an open Courtyard.  You can see several guards involved in combat drills.  You need to be very careful and quiet.\n");
